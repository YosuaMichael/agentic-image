...
Decision history for agentic-image. Documents marked `active` are binding —
to change one, write a new dated plan and register it here.

| Date | Document | Status | What it decides |
|---|---|---|---|
| 2026-09-14 | [initial-plan](2026-09-14-initial-plan.md) | active | Objective, decisions D1–D6, architecture, risks, roadmap |
